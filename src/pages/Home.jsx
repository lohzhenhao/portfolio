        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Project 1 */}
              <Link to="/portfolio/project/project_1" className="group bg-slate-900 border border-slate-800 rounded-lg overflow-hidden hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10">
              ...
              {/* Project 2 */}
              <Link to="/portfolio/project/project_2" className="group bg-slate-900 border border-slate-800 rounded-lg overflow-hidden hover:border-emerald-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10">
              ...
              {/* Project 3 */}
              <Link to="/portfolio/project/project_3" className="group bg-slate-900 border border-slate-800 rounded-lg overflow-hidden hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10">
              ...
              {/* Project 4 */}
              <Link to="/portfolio/project/project_4" className="group bg-slate-900 border border-slate-800 rounded-lg overflow-hidden hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10">
